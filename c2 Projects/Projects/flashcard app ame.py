...
def load_questions(filename='questions.txt'):
    ...
    with open (filename, 'r') as questionsandanswers:
        questions_list = questionsandanswers.readline()
...
submit_button = tk.Button("Submit Answer: ")
