...
def print_board(bd):
    print("   a     b     c     d")  
    print("      |     |     |     ")
    print("1  "+bd[0][0]+"  |  "+bd[0][1]+"  |  "+bd[0][2]+"  |  "+bd[0][3])
    print(" _____|_____|_____|_____")
    print("      |     |     |      ")
    print("2  "+bd[1][0]+"  |  "+bd[1][1]+"  |  "+bd[1][2]+"  |  "+bd[1][3])
    print(" _____|_____|_____|_____")
    print("      |     |     |     ")
    print("3  "+bd[2][0]+"  |  "+bd[2][1]+"  |  "+bd[2][2]+"  |  "+bd[2][3])     
    print(" _____|_____|_____|_____")
    print("      |     |     |")
    print("4  "+bd[3][0]+"  |  "+bd[3][1]+"  |  "+bd[3][2]+"  |  "+bd[3][3])
    print("      |     |     |")          
'''
...
'''
def check_win(bd, ch):
    if ch==bd[0][0]==bd[0][1]==bd[0][2]==bd[0][3]:
        return True
    elif ch==bd[1][0]==bd[1][1]==bd[1][2]==bd[1][3]:
        return True
    elif ch==bd[2][0]==bd[2][1]==bd[2][2]==bd[2][3]:
        return True
    elif ch==bd[3][0]==bd[3][1]==bd[3][2]==bd[3][3]:
        return True
    elif ch==bd[0][0]==bd[1][0]==bd[2][0]==bd[3][0]:
        return True
    elif ch==bd[0][1]==bd[1][1]==bd[2][1]==bd[3][1]:
       return True
    elif ch==bd[0][2]==bd[1][2]==bd[2][2]==bd[3][2]:
        return True
    elif ch==bd[0][3]==bd[1][3]==bd[2][3]==bd[3][3]:
        return True
    elif ch==bd[0][0]==bd[1][1]==bd[2][2]==bd[3][3]:
        return True
    elif ch==bd[0][3]==bd[1][2]==bd[2][1]==bd[3][0]:
        return True
    else:
        return False
